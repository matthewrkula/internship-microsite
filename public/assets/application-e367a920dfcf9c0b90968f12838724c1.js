...
(function() {
  $(document).ready(function() {
    var aboutDiv, appDiv, bgs, blowWind, changeThoughtData, closeInfoBox, closePopUp, cranes, getMoreThoughts, infoBoxIsOpen, infoDiv, openInfoBox, openPopUp, reset, size, startBlowing, switchBackground, thoughtDivs, unusedThoughts;
    infoDiv = $('.info');
    aboutDiv = $('.about');
    appDiv = $('.get-the-app');
    thoughtDivs = $('.thought');
    size = $('.thought').size();
    unusedThoughts = [];
    bgs = ["/assets/backgrounds/flowers.jpg", "/assets/backgrounds/cliffs.jpg", "/assets/backgrounds/forest.jpg", "/assets/backgrounds/harbor.jpg", "/assets/backgrounds/ireland.jpg", "/assets/backgrounds/patagonia.jpg", "/assets/backgrounds/sunset.jpg"];
    cranes = {
    ...
    reset = function() {
      ...
      closeInfoBox();
      setTimeout(function() {
        $.each(thoughtDivs, function(index, thought) {
          return changeThoughtData(thought);
        });
        return switchBackground();
      }, 800);
      return setTimeout(function() {
        return $('.thoughts').css('opacity', 1);
      }, 1000);
    };
    changeThoughtData = function(thought) {
      var newThought;
      ...
      thought.find('.thought-img').attr('src', cranes[newThought.color]);
      return unusedThoughts.push(newThought);
    };
    switchBackground = function() {
      var bg;
      bg = bgs[Math.floor(Math.random() * 7)];
      return $('.thoughts').css('background', "url(" + bg + ")");
    };
    openInfoBox = function(thought) {
      console.log("opening" + thought);
      infoDiv.css({
        'opacity': '1',
      ...
      return infoDiv.find('.info-img').attr('src', thought.data('image'));
    };
    ...
    infoBoxIsOpen = function() {
      return infoDiv.css('opacity') > 0;
    };
    getMoreThoughts = function() {
      return $.get("/random.json", function(data) {
        var i, _i, _ref, _results;
        _results = [];
        for (i = _i = 0, _ref = data.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
          _results.push(unusedThoughts.push({
            text: data[i].text,
            link: data[i].link,
            color: data[i].color
          }));
    ...
    $('#about-link').click(function(e) {
      ...
      if ($(this).closest("span").hasClass('active')) {
        ...
        return openPopUp($(this), aboutDiv);
      }
    });
    $('#app-link').click(function(e) {
      ...
      if ($(this).closest("span").hasClass('active')) {
        ...
        return openPopUp($(this), appDiv);
      }
    });
    $('a').click(function(e) {
      return e.preventDefault();
    });
    thoughtDivs.click(function(e) {
      console.log('asdf');
      closePopUp();
      return openInfoBox($(this));
    });
    startBlowing = function(t) {
      var thought;
      thought = t || $(thoughtDivs[Math.floor(Math.random() * size)]);
      thought.addClass("blowing");
      return setTimeout(function() {
        return thought.removeClass("blowing");
    ...
    blowWind = function() {
      ...
      return setTimeout(startBlowing, 500, $(".thought:eq(4)"));
    };
    blowWind();
    ...
    $('.facebook').hover(function() {
      return $(this).attr('src', '/assets/facebook-hover.png');
    }, function() {
      return $(this).attr('src', '/assets/facebook.png');
    });
    return $('.twitter').hover(function() {
      return $(this).attr('src', '/assets/twitter-hover.png');
    }, function() {
      return $(this).attr('src', '/assets/twitter.png');
    });
  });
