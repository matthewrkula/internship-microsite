...
(function() {
  $(document).ready(function() {
    var aboutDiv, appDiv, bgs, blowWind, changeThoughtData, closeInfoBox, closePopUp, getMoreThoughts, infoBoxIsOpen, infoDiv, openInfoBox, openPopUp, reset, size, startBlowing, switchBackground, thoughtDivs, unusedThoughts;
    infoDiv = $('.info');
    aboutDiv = $('.about');
    appDiv = $('.get-the-app');
    thoughtDivs = $('.thought');
